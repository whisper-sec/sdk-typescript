 ...
 */
export interface InfrastructureMapRequest {
    /**
...
export interface MonitoringAlertRequest {
     ...
     */
    'type': MonitoringAlertRequestTypeEnum;
    /**
...
export const MonitoringAlertRequestTypeEnum = {
    Downtime: 'downtime',
    DnsChange: 'dns_change',
    WhoisChange: 'whois_change',
    SslExpiring: 'ssl_expiring',
    ContentChange: 'content_change',
    TechnologyChange: 'technology_change'
} as const;

export type MonitoringAlertRequestTypeEnum = typeof MonitoringAlertRequestTypeEnum[keyof typeof MonitoringAlertRequestTypeEnum];
...
export interface ScanRequest {
     ...
     */
    'type'?: ScanRequestTypeEnum;
}

export const ScanRequestTypeEnum = {
...
export type ScanRequestTypeEnum = typeof ScanRequestTypeEnum[keyof typeof ScanRequestTypeEnum];
 ...
 */
export interface SimilarDomainsOpsRequest {
    /**
     * The target domain to generate variations for
     */
    'domain': string;
    'options'?: SimilarDomainRequest;
}
/**
...
export const OperationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {InfrastructureMapRequest} infrastructureMapRequest Mapping configuration. Example: &#x60;&#x60;&#x60;json {   \&quot;startPoint\&quot;: \&quot;example.com\&quot;,   \&quot;depth\&quot;: 2 } &#x60;&#x60;&#x60; 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createInfrastructureMap: async (infrastructureMapRequest: InfrastructureMapRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'infrastructureMapRequest' is not null or undefined
            assertParamExists('createInfrastructureMap', 'infrastructureMapRequest', infrastructureMapRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(infrastructureMapRequest, localVarRequestOptions, configuration)
         ...
         * @param {ScanRequest} scanRequest Scan configuration including target domain and scan type.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createInfrastructureScan: async (scanRequest: ScanRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'scanRequest' is not null or undefined
            assertParamExists('createInfrastructureScan', 'scanRequest', scanRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(scanRequest, localVarRequestOptions, configuration)
         ...
         * @param {MonitoringAlertRequest} monitoringAlertRequest Alert configuration including type, thresholds, and notification channels.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createMonitoringAlert: async (target: string, monitoringAlertRequest: MonitoringAlertRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'target' is not null or undefined
            assertParamExists('createMonitoringAlert', 'target', target)
            // verify required parameter 'monitoringAlertRequest' is not null or undefined
            assertParamExists('createMonitoringAlert', 'monitoringAlertRequest', monitoringAlertRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(monitoringAlertRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        listJobs: async (status?: string, limit?: number, offset?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/ops/jobs/list`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @param {SimilarDomainsOpsRequest} similarDomainsOpsRequest Similar domains request with domain and options.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        similarDomains: async (similarDomainsOpsRequest: SimilarDomainsOpsRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'similarDomainsOpsRequest' is not null or undefined
            assertParamExists('similarDomains', 'similarDomainsOpsRequest', similarDomainsOpsRequest)
            const localVarPath = `/v1/ops/similar-domains`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(similarDomainsOpsRequest, localVarRequestOptions, configuration)
...
export const OperationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createInfrastructureMap(infrastructureMapRequest: InfrastructureMapRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createInfrastructureMap(infrastructureMapRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async createInfrastructureScan(scanRequest: ScanRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createInfrastructureScan(scanRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async createMonitoringAlert(target: string, monitoringAlertRequest: MonitoringAlertRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createMonitoringAlert(target, monitoringAlertRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async listJobs(status?: string, limit?: number, offset?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listJobs(status, limit, offset, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OperationsApi.listJobs']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * <p>Create a recurring job to capture website screenshots at regular intervals. Essential for monitoring website changes, detecting defacements, and tracking competitor updates.</p> <h4>Schedule Options:</h4> <ul>     <li><b>Cron Expression:</b> Full cron syntax support (e.g., `0 0 * * * *` = hourly)</li>     <li><b>Frequency Presets:</b> hourly, daily, weekly, monthly</li>     <li><b>Timezone:</b> Specify timezone for accurate scheduling</li>     <li><b>Retention:</b> Auto-cleanup old screenshots (default: keep last 30)</li> </ul> <h4>Performance:</h4> <ul>     <li><b>Setup Time:</b> ~2 seconds to create schedule</li>     <li><b>Screenshot Time:</b> 10-30 seconds per capture</li> </ul> <h4>Use Cases:</h4> <ul>     <li>Automated defacement detection</li>     <li>Compliance monitoring and archival</li>     <li>Competitor website tracking</li>     <li>Visual regression testing</li> </ul> 
         ...
         * @throws {RequiredError}
         */
        async similarDomains(similarDomainsOpsRequest: SimilarDomainsOpsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.similarDomains(similarDomainsOpsRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OperationsApi.similarDomains']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const OperationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createInfrastructureMap(infrastructureMapRequest: InfrastructureMapRequest, options?: RawAxiosRequestConfig): AxiosPromise<JobResponse> {
            return localVarFp.createInfrastructureMap(infrastructureMapRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * <p>Initiates a comprehensive security scan of a domain\'s infrastructure. Performs reconnaissance, port scanning, service detection, and vulnerability assessment.</p> <h4>Scan Types:</h4> <ul>     <li><b>comprehensive:</b> Full scan including all modules (recommended for complete assessment)</li>     <li><b>subdomains:</b> Subdomain enumeration only</li>     <li><b>ports:</b> Port scanning and service detection</li>     <li><b>technologies:</b> Technology stack detection</li>     <li><b>vulnerabilities:</b> Known vulnerability checks</li>     <li><b>ssl:</b> SSL/TLS configuration and certificate analysis</li>     <li><b>dns:</b> DNS configuration and zone transfer tests</li>     <li><b>whois:</b> Registration and ownership information</li> </ul> <h4>Performance:</h4> <ul>     <li><b>Quick scans:</b> 30-60 seconds (subdomains, dns, whois)</li>     <li><b>Comprehensive scan:</b> 5-15 minutes depending on infrastructure size</li> </ul> <h4>Use Cases:</h4> <ul>     <li>Pre-engagement reconnaissance for penetration testing</li>     <li>Attack surface assessment</li>     <li>Infrastructure inventory and mapping</li>     <li>Vulnerability management</li> </ul> 
         * @summary Infrastructure Security Scan (Asynchronous)
         ...
         * @throws {RequiredError}
         */
        createInfrastructureScan(scanRequest: ScanRequest, options?: RawAxiosRequestConfig): AxiosPromise<JobResponse> {
            return localVarFp.createInfrastructureScan(scanRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * <p>Create alert rules for a monitored asset. Get notified via webhook, email, or Slack when specific conditions are met.</p> <h4>Alert Types:</h4> <ul>     <li><b>downtime:</b> Site becomes unreachable</li>     <li><b>dns_change:</b> DNS records modified</li>     <li><b>whois_change:</b> Registration details updated</li>     <li><b>ssl_expiring:</b> Certificate expires soon (7, 14, 30 days)</li>     <li><b>content_change:</b> Page content modified</li>     <li><b>technology_change:</b> Tech stack changes detected</li> </ul> <h4>Notification Channels:</h4> <ul>     <li>Webhook (POST to your endpoint)</li>     <li>Email</li>     <li>Slack</li>     <li>PagerDuty</li> </ul> <h4>Example Configuration:</h4> <pre><code>{   \"type\": \"ssl_expiring\",   \"threshold_days\": 14,   \"channels\": [\"email\", \"slack\"],   \"email\": \"alerts@example.com\",   \"slack_webhook\": \"https://hooks.slack.com/...\" }</code></pre> 
         * @summary Configure Monitoring Alerts (Asynchronous)
         ...
         * @throws {RequiredError}
         */
        createMonitoringAlert(target: string, monitoringAlertRequest: MonitoringAlertRequest, options?: RawAxiosRequestConfig): AxiosPromise<JobResponse> {
            return localVarFp.createMonitoringAlert(target, monitoringAlertRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * <p>Initiates an asynchronous job to capture a screenshot of a website. Supports various viewport sizes, full-page captures, and JavaScript rendering.</p> <p><b>Performance Note:</b> A typical screenshot capture takes 10-30 seconds. Poll the `/v1/ops/jobs/{jobId}` endpoint to retrieve the URL of the final image.</p> <p><b>Output:</b> The job result will contain a URL to download the screenshot image in the specified format (PNG, JPEG, or WebP).</p> 
         * @summary Capture a Website Screenshot (Asynchronous)
         ...
         * @throws {RequiredError}
         */
        listJobs(status?: string, limit?: number, offset?: number, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.listJobs(status, limit, offset, options).then((request) => request(axios, basePath));
        },
        /**
         * <p>Create a recurring job to capture website screenshots at regular intervals. Essential for monitoring website changes, detecting defacements, and tracking competitor updates.</p> <h4>Schedule Options:</h4> <ul>     <li><b>Cron Expression:</b> Full cron syntax support (e.g., `0 0 * * * *` = hourly)</li>     <li><b>Frequency Presets:</b> hourly, daily, weekly, monthly</li>     <li><b>Timezone:</b> Specify timezone for accurate scheduling</li>     <li><b>Retention:</b> Auto-cleanup old screenshots (default: keep last 30)</li> </ul> <h4>Performance:</h4> <ul>     <li><b>Setup Time:</b> ~2 seconds to create schedule</li>     <li><b>Screenshot Time:</b> 10-30 seconds per capture</li> </ul> <h4>Use Cases:</h4> <ul>     <li>Automated defacement detection</li>     <li>Compliance monitoring and archival</li>     <li>Competitor website tracking</li>     <li>Visual regression testing</li> </ul> 
         * @summary Schedule Recurring Screenshots (Asynchronous)
         ...
         * @throws {RequiredError}
         */
        similarDomains(similarDomainsOpsRequest: SimilarDomainsOpsRequest, options?: RawAxiosRequestConfig): AxiosPromise<JobResponse> {
            return localVarFp.similarDomains(similarDomainsOpsRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class OperationsApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public createInfrastructureMap(infrastructureMapRequest: InfrastructureMapRequest, options?: RawAxiosRequestConfig) {
        return OperationsApiFp(this.configuration).createInfrastructureMap(infrastructureMapRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public createInfrastructureScan(scanRequest: ScanRequest, options?: RawAxiosRequestConfig) {
        return OperationsApiFp(this.configuration).createInfrastructureScan(scanRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public createMonitoringAlert(target: string, monitoringAlertRequest: MonitoringAlertRequest, options?: RawAxiosRequestConfig) {
        return OperationsApiFp(this.configuration).createMonitoringAlert(target, monitoringAlertRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public listJobs(status?: string, limit?: number, offset?: number, options?: RawAxiosRequestConfig) {
        return OperationsApiFp(this.configuration).listJobs(status, limit, offset, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public similarDomains(similarDomainsOpsRequest: SimilarDomainsOpsRequest, options?: RawAxiosRequestConfig) {
        return OperationsApiFp(this.configuration).similarDomains(similarDomainsOpsRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
